...
void bleDeliver(JsonObject &BLEdata, PsychicEventSource &eventSource) {
    if (decoder.decodeBLEJson(BLEdata)) {
        ...
        serializeJson(BLEdata, output, sizeof(output));
